export default function Index() {
  ...
  return (
    <div id="zero-state">
      ...
      <br />
      <br />
      <h4>What's New in 6.4?</h4>
      <p> Version 6.4 is the most exciting release yet, featuring new data abstractions for reading, writing, and navigation hooks to easily synchronize the UI with the data. </p>
      <br />
      <h4>What I can do?</h4>
      <ul>
        <li>Try creating a new contact!</li>
        <i>(There is an example contact to begin with.)</i>
        <li>Navigate through already created contacts.</li>
